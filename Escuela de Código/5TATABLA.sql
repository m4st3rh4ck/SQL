...
UPDATE Alumnos
SET nombre_alumno = "Omar"
WHERE nombre_alumno = "Hugo";
...
/*COUNT es para contar el numero de filas*/
FROM Informacion_Laboral_Docentes;

SELECT COUNT (*)
/*COUNT (*) es para todas las filas de una tabla, sin importar si hay valores nulos en las columnas. */
FROM Informacion_Laboral_Docentes;
...
SELECT SUM (ILD.salario)
FROM Informacion_Laboral_Docentes AS ILD;
/*AS es para poner alias a campos y no tener que escribir todo el nombre*/

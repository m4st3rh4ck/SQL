...
SELECT *
FROM Talleres
ORDER BY id_area DESC, nombre_taller ASC;

/*SHOW TABLES ES PARA MOSTRAR TODAS LAS TABLAS DE UNA BASE DE DATOS*/

/* ORDEN DE EJECUCION DE INTRUCCIONES, NO ES LINEAL ES POR JERARQUIA
FROM
JOIN
WHERE
GROUP BY

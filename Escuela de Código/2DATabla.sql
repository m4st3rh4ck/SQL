...
INSERT INTO docentes (nombre_docente, clave_docente, correo_docente)
VALUES ('Ricardo Vargas', 'Sin datos', 'ricardo.vargas@pilares.net');
INSERT INTO docentes (nombre_docente, clave_docente, correo_docente)
...
VALUES ('Ana Torres', 'DOP-890', 'ana.torres@pilares.net');
INSERT INTO docentes (nombre_docente, clave_docente, correo_docente)
VALUES ('Laura Ramírez', 'Sin datos', 'laura.ramirez@pilares.net');
INSERT INTO docentes (nombre_docente, clave_docente, correo_docente)
VALUES ('Carlos Méndez', 'DOP-345', 'Sin dato');
INSERT INTO docentes (nombre_docente, clave_docente, correo_docente)
VALUES ('Carlos Méndez', 'Sin dato', 'Sin dato');

SELECT * FROM docentes;
SELECT DISTINCT /*DISTINCT es para eliminar datos repetidos*/
       nombre_docente,
       correo_docente
FROM docentes;
SELECT DISTINCT

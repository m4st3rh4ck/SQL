...
/*QUERY*/
SELECT * 
FROM Informacion_Laboral_Docentes ILD;
...
FROM Informacion_Laboral_Docentes;
/*query para contar cuantos registros son*/

SELECT DISTINCT 
ILD.salario
FROM Informacion_Laboral_Docentes ILD
ORDER BY ILD.salario ASC;
/*query para ordenar*/

SELECT ILD.salario AS Salario_Docente
FROM Informacion_Laboral_Docentes ILD
GROUP BY ILD.salario
ORDER BY ILD.salario ASC;

SELECT ILD.salario AS Salario_Docente,
       ILD.estado_laboral AS Estado_Laboral_Docente
FROM Informacion_Laboral_Docentes ILD
GROUP BY ILD.salario, ILD.estado_laboral
ORDER BY ILD.estado_laboral, ILD.salario;

SELECT DISTINCT COUNT (ILD.salario) 
FROM Informacion_Laboral_Docentes ILD
WHERE ILD.salario >= 8500
ORDER BY ILD.salario DESC;

SELECT COUNT(ILD.salario),
ILD.estado_laboral
FROM Informacion_Laboral_Docentes ILD
WHERE ILD.salario >= 8500
GROUP BY ILD.estado_laboral
ORDER BY ILD.estado_laboral DESC;
